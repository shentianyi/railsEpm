define(["jquery","dhtmlx.dataview"],function($,dhtmlXDataView){
//    function get_dhtmlx(){
...
//        Share.current_status_loader = new SVGLoader( document.getElementById( 'current_status_loader' ), { speedIn : 100 } );
...
//        Share.current_status_loader.show();
//    }
//    function loader_hide(){
//        Share.current_status_loader.hide();
//    }
...
//                            '</div>';
//                        color_type=Share.color.ftq[a[i]];
