...
function prepare_for_create_report_story() {
    var story = {title: $("#story-title").val(),
        description: $("#story-desc").val(),
        story_set_id: $("#story-sets option:selected").attr("value"),
        chart_type: Report.option.type};
    var attachments = MANAGE.story.get_attachments('item-data-uploader-preview');
    var chart_conditions = [];

    var condition = {};
    condition.data = Report.serializeToJSONString();
    chart_conditions.push(condition);
