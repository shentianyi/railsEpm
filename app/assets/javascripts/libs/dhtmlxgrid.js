...
if (typeof(window.dhx4) == "undefined") {
    window.dhx4 = {version: "4.0.3", skin: null, skinDetect: function (b) {
...
if (typeof(window.dhx4.ajax) == "undefined") {
    window.dhx4.ajax = {cache: false, method: "post", get: function (a, b) {
        ...
        if (f == true) {
            c.onreadystatechange = function () {
                if ((c.readyState == 4 && c.status == 200) || (g == true && c.readyState == 3)) {
    ...
    this.getUpdates(c, function () {
        ...
        if (d.length) {
            ...
            for (var g = 0; g < d.length; g++) {
                ...
                var j = d[g].getAttribute("id");
                var h = d[g].getAttribute("parent");
                switch (e) {
                    case"inserted":
                        b.callEvent("insertCallback", [d[g], j, h]);
                        break;
                    case"updated":
                        b.callEvent("updateCallback", [d[g], j, h]);
                        break;
                    case"deleted":
                        b.callEvent("deleteCallback", [d[g], j, h]);
                        break
                }
            }
...
if (window.dhtmlXGridObject && !dhtmlXGridObject.prototype._init_point_connector) {
    ...
    dhtmlXGridObject.prototype._init_point = function () {
        ...
        var a = function (e) {
            ...
            return e + (e.indexOf("?") != -1 ? "&" : "?") + "connector=true" + (this.hdr.rows.length > 0 ? "&dhx_no_header=1" : "")
        };
        var d = function (e) {
            return a.call(this, e) + (this._connector_sorting || "") + (this._connector_filter || "")
        };
        ...
        var b = function (f, e, h) {
            var j = [];
            for (var g = 0; g < e.length; g++) {
                j[g] = "dhx_filter[" + e[g] + "]=" + encodeURIComponent(h[g])
            }
            this._connector_filter = "&" + j.join("&");
            return d.call(this, f)
        };
    ...
    dhtmlXGridObject.prototype._parseHead = function (b, q, n) {
        ...
        if (!this._colls_loaded) {
            ...
            for (var h = 0; h < o.length; h++) {
                ...
                var g = this.xmlLoader.doXPath("./item", o[h]);
                var a = [];
...
function dhtmlXCalendarObject(f, l) {
    ...
    this.conf = {skin: (l || window.dhx4.skin || (typeof(dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhtmlxcalendar") || "dhx_skyblue"), zi: window.dhx4.newId(), touch: (typeof(window.ontouchstart) != "undefined")};
    ...
    g.appendChild(j);
    var e = this;
    j[this.conf.touch ? "ontouchstart" : "onclick"] = function (o) {
        o = o || event;
    ...
    this.contDates[this.conf.touch ? "ontouchend" : "onclick"] = function (q) {
        q = q || event;
    ...
    this._drawMonth = function (t) {
        if (!(t instanceof Date)) {
            return
        }
        if (isNaN(t.getFullYear())) {
            t = new Date(this._activeMonth.getFullYear(), this._activeMonth.getMonth(), 1, 0, 0, 0, 0)
        }
        this._activeMonth = new Date(t.getFullYear(), t.getMonth(), 1, 0, 0, 0, 0);
        this._activeDateCell = null;
        var r = new Date(this._activeMonth.getTime());
        var n = r.getDay();
        var x = n - this._wStart;
        if (x < 0) {
            x = x + 7
        }
        ...
        for (var m = 0; m < 6; m++) {
            ...
            for (var z = 0; z <= 7; z++) {
                if (z == 0) {
                    var y = this.getWeekNumber(new Date(r.getFullYear(), r.getMonth(), r.getDate() + p, 0, 0, 0, 0));
                    this.contDates.childNodes[m].childNodes[z].innerHTML = "<div class='dhtmlxcalendar_label'>" + y + "</div>"
                } else {
                    var a = new Date(r.getFullYear(), r.getMonth(), r.getDate() + p, 0, 0, 0, 0);
                    var v = a.getDay();
                    var o = a.getTime();
                    var u = "dhtmlxcalendar_label";
                    if (this._tipData[o] != null) {
                        if (this._tipData[o].usePopup && typeof(window.dhtmlXPopup) == "function") {
                            this.contDates.childNodes[m].childNodes[z].removeAttribute("title");
                            this._initTooltipPopup()
                        } else {
                            this.contDates.childNodes[m].childNodes[z].setAttribute("title", this._tipData[o].text)
                        }
                        if (this._tipData[o].showIcon) {
                            u += " dhtmlxcalendar_label_title"
                        }
                    } else {
                        this.contDates.childNodes[m].childNodes[z].removeAttribute("title")
                    }
                    this.contDates.childNodes[m].childNodes[z].innerHTML = "<div class='" + u + "'>" + a.getDate() + "</div>";
                    this.contDates.childNodes[m].childNodes[z]._date = new Date(o);
                    this.contDates.childNodes[m].childNodes[z]._q = m;
                    this.contDates.childNodes[m].childNodes[z]._w = z;
                    this.contDates.childNodes[m].childNodes[z]._css_month = (a.getMonth() == A);
                    this.contDates.childNodes[m].childNodes[z]._css_date = (!this._nullDate && o == C);
                    this.contDates.childNodes[m].childNodes[z]._css_weekend = (s >= 6);
                    this.contDates.childNodes[m].childNodes[z]._css_dis = this._isOutOfRange(o);
                    this.contDates.childNodes[m].childNodes[z]._css_holiday = (this._holidays[o] == true);
                    this._updateCellStyle(m, z);
                    if (o == C) {
                        this._activeDateCell = this.contDates.childNodes[m].childNodes[z]
                    }
                    if (++s > 7) {
                        s = 1
                    }
        ...
        this.contMonth.firstChild.firstChild.childNodes[1].innerHTML = this._buildMonthHdr(t)
    };
    ...
    this._initSelector = function (t, o) {
        ...
        if (t == "minutes") {
            ...
            this.rsCont[this.conf.touch ? "ontouchstart" : "onclick"] = function (x) {
                x = x || event;
                x.cancelBubble = true;
    ...
    this._showSelector = function (p, m, q, o, a) {
        ...
        this._sel._t = p;
        this._sel.className = "dhtmlxcalendar_selector_obj dhtmlxcalendar_" + o;
    ...
    this.setDateFormat(this.langData[this.lang].dateformat || "%Y-%m-%d");
    this._getInd = function (n, a) {
        for (var m = 0; m < a.length; m++) {
            if (a[m].toLowerCase() == n) {
                return m
            }
        }
        return -1
    ...
    this.getWeekNumber = function (p) {
        ...
        var q = n - u;
        var s = new Date(p.getFullYear(), 0, 1 - q + r * 7, 0, 0, 0, 0);
        var w = 604800000;
        var a = new Date(p.getFullYear(), p.getMonth(), p.getDate() + 1, 0, 0, 0, 0);
        var v = Math.ceil((a.getTime() - s.getTime()) / w);
        return v
    };
    ...
    this._show = function (r, a) {
        ...
        if (!r) {
            ...
            var o = (this.i[r].input || this.i[r].button);
            var m = (navigator.appVersion.indexOf("MSIE") != -1);
            var p = Math.max((m ? document.documentElement : document.getElementsByTagName("html")[0]).scrollTop, document.body.scrollTop);
            var n = p + (m ? Math.max(document.documentElement.clientHeight || 0, document.documentElement.offsetHeight || 0, document.body.clientHeight || 0) : window.innerHeight);
            if (this.pos == "right") {
                this.base.style.left = this._getLeft(o) + o.offsetWidth + "px";
                this.base.style.top = Math.min(this._getTop(o), n - this.base.offsetHeight) + "px"
            } else {
                if (this.pos == "bottom") {
                    var q = this._getTop(o) + o.offsetHeight + 1;
                    if (q + this.base.offsetHeight > n) {
                        q = this._getTop(o) - this.base.offsetHeight
                    }
                    this.base.style.left = this._getLeft(o) + "px";
    ...
    this._posGetOffsetSum = function (a) {
        var n = 0, m = 0;
        while (a) {
            n = n + parseInt(a.offsetTop);
            m = m + parseInt(a.offsetLeft);
            a = a.offsetParent
        }
        return{top: n, left: m}
    };
    this._posGetOffsetRect = function (o) {
        var r = o.getBoundingClientRect();
        var s = document.body;
        var m = document.documentElement;
        var a = window.pageYOffset || m.scrollTop || s.scrollTop;
        var p = window.pageXOffset || m.scrollLeft || s.scrollLeft;
        var q = m.clientTop || s.clientTop || 0;
        var t = m.clientLeft || s.clientLeft || 0;
        var u = r.top + a - q;
        var n = r.left + p - t;
        return{top: Math.round(u), left: Math.round(n)}
    };
        ...
        for (var r = 0; r < this.contDates.childNodes.length; r++) {
            for (var a = 0; a < this.contDates.childNodes[r].childNodes.length; a++) {
                ...
                if (s._date != null && s._date.getTime() == o) {
                    m = {x: this._getLeft(s), y: this._getTop(s), w: s.offsetWidth, h: s.offsetHeight}
                }
                s = null
            }
        }
    ...
    this._attachEventsToObject = function (m) {
        if (this.i[m].button != null) {
            ...
            if (typeof(window.addEventListener) == "function") {
                this.i[m].button.addEventListener((this.conf.touch ? "touchstart" : "click"), e._doOnBtnClick, false)
            } else {
            ...
            if (this.i[m].input != null) {
                ...
                if (typeof(window.addEventListener) == "function") {
                    this.i[m].input.addEventListener((this.conf.touch ? "touchstart" : "click"), e._doOnInpClick, false);
    ...
    this._detachEventsFromObject = function (m) {
        if (this.i[m].button != null) {
            if (typeof(window.addEventListener) == "function") {
                this.i[m].button.removeEventListener((this.conf.touch ? "touchstart" : "click"), e._doOnBtnClick, false)
            } else {
            ...
            if (this.i[m].input != null) {
                if (typeof(window.addEventListener) == "function") {
                    this.i[m].input.removeEventListener((this.conf.touch ? "touchstart" : "click"), e._doOnInpClick, false);
...
dhtmlXCalendarObject.prototype._strToDate = function (g, s) {
    ...
    var c = {"%y": 1, "%Y": 1, "%n": 2, "%m": 2, "%M": 2, "%F": 2, "%d": 3, "%j": 3, "%a": 4, "%A": 4, "%H": 5, "%G": 5, "%h": 5, "%g": 5, "%i": 6, "%s": 7};
    var n = {};
    var i = {};
    ...
    for (var b = 0; b < u.length; b++) {
        switch (l[b]) {
            ...
            case"%s":
                if (!isNaN(u[b])) {
                    a[{"%d": "setDate", "%j": "setDate", "%n": "setMonth", "%m": "setMonth", "%Y": "setFullYear", "%H": "setHours", "%G": "setHours", "%i": "setMinutes", "%s": "setSeconds"}[l[b]]](Number(u[b]) + (l[b] == "%m" || l[b] == "%n" ? -1 : 0))
                }
                break;
            case"%M":
            case"%F":
                var h = this._getInd(u[b].toLowerCase(), j.langData[j.lang][{"%M": "monthesSNames", "%F": "monthesFNames"}[l[b]]]);
                if (h >= 0) {
                    a.setMonth(h)
                }
                break;
...
function dhtmlXCombo(f, j, c, h, e) {
    ...
    this.conf = {skin: null, form_name: j || "dhxcombo", combo_width: (parseInt(c) || this.cont.offsetWidth || 120) - (dhx4.isFF || dhx4.isIE ? 2 : 0), combo_image: false, combo_focus: false, opts_type: (typeof(h) == "string" && typeof(this.modes[h]) != "undefined" ? h : "option"), opts_count: 8, opts_count_min: 3, opts_width: null, item_h: null, list_zi_id: window.dhx4.newId(), allow_free_text: true, allow_empty_value: true, enabled: true, img_path: "", img_def: "", img_def_dis: true, template: {input: "#text#", option: "#text#"}, f_mode: false, f_url: false, f_cache: false, f_cache_data: {}, f_dyn: false, f_dyn_end: false, f_mask: "", f_ac: true, f_ac_text: "", f_server_tm: null, f_server_last: "", last_hover: null, last_selected: null, last_match: null, last_text: "", last_value: "", tm_hover: null, tm_confirm_blur: null, clear_click: false, clear_blur: false, clear_bsp: false, clear_key: false, sp: {dhx_skyblue: {list_ofs: 1}, dhx_web: {list_ofs: 0}, dhx_terrace: {list_ofs: 1}}};
    ...
    this._filterOpts = function (u) {
        ...
        var n = String(this.base.firstChild.value).replace(new RegExp(this.conf.f_ac_text + "$", "i"), "");
        if (this.conf.f_server_last == n.toLowerCase()) {
            this._checkForMatch();
            return
        }
        if (this.conf.f_url != null && this.checkEvent("onDynXLS")) {
            this.conf.f_server_last = n.toLowerCase();
            this.callEvent("onDynXLS", [n]);
            return
        }
        if (this.conf.f_url != null) {
            ...
            if (this.conf.f_cache == true && this.conf.f_cache_data[n] != null) {
                this.clearAll();
                this.conf.f_server_last = n.toLowerCase();
                for (var p = 0; p < this.conf.f_cache_data[n].data.length; p++) {
                    this.load(this.conf.f_cache_data[n].data[p])
                }
                if (this.conf.f_dyn) {
                    this.conf.f_dyn_end = this.conf.f_cache_data[n].dyn_end;
                    this.conf.f_mask = this.conf.f_cache_data[n].mask
                }
                if (u !== true) {
                    this._showList(true);
                    this._checkForMatch()
                ...
                this.conf.f_server_tm = window.setTimeout(function () {
                    g.conf.f_server_last = n.toLowerCase();
                    g.conf.f_mask = n;
                    var q = "mask=" + encodeURIComponent(n);
                    if (g.conf.f_dyn) {
                        q += "&pos=0";
                    ...
                    var a = function (w) {
                        if (g.conf.f_cache) {
                            if (!g.conf.f_cache_data[n]) {
                                g.conf.f_cache_data[n] = {data: [], dyn_end: false, mask: n}
                            }
                            g.conf.f_cache_data[n].data.push(w.xmlDoc.responseXML)
                        }
                        g.clearAll();
                        g.load(w.xmlDoc.responseXML);
                        if (g.conf.f_ac && g.conf.f_mode == "start" && g.conf.clear_bsp == false && g.list.firstChild != null) {
                            var v = g.list.firstChild._optId;
                            var x = String(g.t[v].obj.getText(g.list.firstChild, true));
                            if (String(x).toLowerCase().indexOf(String(n).toLowerCase()) === 0) {
                                g.base.firstChild.value = x;
                                g._selectRange(n.length, x.length)
                            }
                        }
                        if (u !== true) {
                            g._showList(true);
            ...
            this.conf.f_server_last = n.toLowerCase();
            var o = (n.length == 0 ? true : new RegExp((this.conf.f_mode == "start" ? "^" : "") + n, "i"));
            var t = null;
            for (var m in this.t) {
                var s = this.t[m].obj.getText(this.t[m].item, true);
                if (o === true || o.test(s) == true) {
                    this.t[m].item.style.display = "";
                    if (t == null && n.length > 0) {
                        t = String(this.t[m].obj.getText(this.t[m].item, true))
                    }
                } else {
                    this.t[m].item.style.display = "none"
                }
            }
            if (this.conf.f_ac && this.conf.f_mode == "start" && this.conf.clear_bsp == false && t != null) {
                this.conf.f_ac_text = t.replace(new RegExp("^" + n, "i"), "");
                this.base.firstChild.value = t;
    ...
    this._xmlToObj = function (v, y) {
        var D = {options: []};
        var z = (y == true ? v : v.getElementsByTagName("complete"));
        if (z.length > 0) {
            var o = z[0].childNodes;
            for (var m = 0; m < o.length; m++) {
                if (typeof(o[m].tagName) != "undefined") {
                    if (String(o[m].tagName).toLowerCase() == "template") {
                        for (var C = 0; C < o[m].childNodes.length; C++) {
                            if (o[m].childNodes[C].tagName != null) {
                                var u = o[m].childNodes[C].tagName;
                                if (typeof(this.conf.template[u]) != "undefined") {
                                    this.conf.template[u] = (o[m].childNodes[C].firstChild != null ? o[m].childNodes[C].firstChild.nodeValue : "")
                                }
                            }
                        }
                    }
                    if (String(o[m].tagName).toLowerCase() == "option") {
                        var s = false;
                        if (y == true) {
                            s = (window.dhx4.s2b(o[m].selected) || o[m].getAttribute("selected") != null)
                        } else {
                            s = window.dhx4.s2b(o[m].getAttribute("selected"))
                        }
                        var p = {value: o[m].getAttribute("value"), text: (o[m].firstChild != null ? o[m].firstChild.nodeValue : ""), selected: s, checked: window.dhx4.s2b(o[m].getAttribute("checked"))};
                        for (var A in {img: 1, img_dis: 1, img_src: 1, img_src_dis: 1}) {
                            if (o[m].getAttribute(A) != null) {
                                p[A] = o[m].getAttribute(A)
                            }
                        }
                        for (var C = 0; C < o[m].childNodes.length; C++) {
                            if (o[m].childNodes[C].tagName != null && String(o[m].childNodes[C].tagName).toLowerCase() == "text") {
                                p.text = {};
                                var r = o[m].childNodes[C];
                                for (var x = 0; x < r.childNodes.length; x++) {
                                    if (r.childNodes[x].tagName != null) {
                                        p.text[r.childNodes[x].tagName] = (r.childNodes[x].firstChild != null ? r.childNodes[x].firstChild.nodeValue : "")
                                    }
                                }
                            }
                        }
...
dhtmlXCombo.prototype._checkListHeight = function () {
    ...
    if (this.conf.item_h == null) {
        var i = this.list.firstChild;
        while (i != null) {
            if (i.style.display == "") {
                this.conf.item_h = i.offsetHeight;
                i = null
            } else {
                i = i.nextSibling
            }
    ...
    var j = window.dhx4.screenDim();
    var e = window.dhx4.absTop(this.base);
    var a = this.base.offsetHeight;
    var b = Math.max(0, Math.floor((e - j.top) / this.conf.item_h));
    var g = Math.max(0, Math.floor((j.bottom - (e + a)) / this.conf.item_h));
    var l = this._getListVisibleCount();
    if (g < Math.min(this.conf.opts_count_min, l) && b > g) {
        g = null
    }
    var f = Math.min((g == null ? b : g), this.conf.opts_count, l);
    var c = (f < l ? (f * this.conf.item_h) + "px" : "");
    var d = this.conf.sp[this.conf.skin].list_ofs;
    this.list.style.height = c;
    this.list.style.top = (g == null ? e - this.list.offsetHeight + d : e + a - d) + "px"
};
dhtmlXCombo.prototype._scrollToItem = function (e) {
    ...
    if (d < b) {
        this.list.scrollTop = d
    } else {
        if (c > a) {
            this.list.scrollTop = c - this.list.clientHeight
        }
    }
};
...
dhtmlXCombo.prototype._renderOption = function (b) {
    ...
    this.t[a._optId] = {obj: this.modes[this.conf.opts_type].render(a, b), item: a, conf: {type: this.conf.opts_type}};
    a = null;
    return c
};
...
dhtmlXCombo.prototype._getOption = function (g, d) {
    ...
    var e = {value: this.t[g].obj.getValue(this.t[g].item), text: this.t[g].obj.getText(this.t[g].item), text_input: this.t[g].obj.getText(this.t[g].item, true), text_option: this.t[g].obj.getText(this.t[g].item, null, true), css: this.t[g].obj.getCss(this.t[g].item), selected: (g == this.conf.last_selected), index: d};
...
dhtmlXCombo.prototype.modes.option = {image: false, option_css: "dhxcombo_option_text", render: function (a, b) {
...
dhtmlXCombo.prototype.modes.checkbox = {image: true, image_css: "dhxcombo_checkbox dhxcombo_chbx_#state#", option_css: "dhxcombo_option_text dhxcombo_option_text_chbx", render: function (a, b) {
...
dhtmlXCombo.prototype.modes.image = {image: true, image_css: "dhxcombo_image", option_css: "dhxcombo_option_text dhxcombo_option_text_image", render: function (a, b) {
    a._conf = {value: b.value, css: ""};
    a.className = "dhxcombo_option";
...
function dhtmlXMenuObject(e, f) {
    ...
    if (typeof(e) == "object" && e != null && typeof(e.tagName) == "undefined") {
        ...
        for (var c in {json: 1, xml: 1, items: 1, top_text: 1, align: 1, open_mode: 1, overflow: 1, dynamic: 1, dynamic_icon: 1, context: 1, onload: 1, onclick: 1, oncheckboxclick: 1, onradioclick: 1}) {
            if (e[c] != null) {
    ...
    this._showPolygon = function (v, i) {
        ...
        if ((this.idPull[z] != null) && (this.idPull[v] != null)) {
            ...
            if (this.conf.auto_overflow) {
                if (this.idPull[z].firstChild.offsetHeight > this.conf.v.y1 + this.conf.v.y2) {
                    var r = Math.floor((this.conf.v.y2 - this.conf.v.y1 - 35) / 24);
            ...
            if (this.conf.overflow_limit > 0) {
                if (this.conf.overflow_limit < E) {
                    this.idPull[z].childNodes[1].style.height = 24 * this.conf.overflow_limit + "px";
            ...
            var C = this.idPull[z].childNodes[1].offsetHeight + A + D;
            if (i == "bottom") {
                if (this.conf.rtl) {
                    o = a + (g != null ? g : 0) - q
                } else {
...
dhtmlXMenuObject.prototype._updateItemImage = function (c, d) {
    ...
    if (this.itemPull[c]["type"] == "radio") {
        var j = this.itemPull[c][(this.itemPull[c]["state"] == "enabled" ? "imgen" : "imgdis")]
    } else {
        var j = this.itemPull[c][(this.itemPull[c]["state"] == "enabled" ? "imgen" : "imgdis")]
    }
    if (j.length > 0) {
...
dhtmlXMenuObject.prototype._addItemIntoGlobalStrorage = function (h, a, c, g, d, b, f) {
    var e = {id: h, title: c, imgen: (b != null ? b : ""), imgdis: (f != null ? f : ""), type: g, state: (d == true ? "disabled" : "enabled"), parent: a, complex: false, hotkey: "", tip: ""};
...
function dhtmlXToolbarObject(b, c) {
    var a = this;
    this.conf = {skin: (c || window.dhx4.skin || (typeof(dhtmlx) != "undefined" ? dhtmlx.skin : null) || window.dhx4.skinDetect("dhxtoolbar") || "dhx_skyblue"), align: "left", align_autostart: "left", icons_path: "", iconSize: 18, sel_ofs_x: 0, sel_ofs_y: 0, xml_autoload: null, items_autoload: null};
...
dhtmlXToolbarObject.prototype.addButtonSelect = function (d, h, l, a, b, i, g, n, e, f) {
    ...
    this._addItem({id: d, type: "buttonSelect", text: l, img: b, imgdis: i, renderSelect: g, openAll: n, options: m, maxOpen: e, mode: f}, h)
};
...
dhtmlXToolbarObject.prototype.addSlider = function (b, g, e, d, i, c, f, a, h) {
    this._addItem({id: b, type: "slider", length: e, valueMin: d, valueMax: i, valueNow: c, textMin: f, textMax: a, toolTip: h}, g)
};
...
dhtmlXToolbarObject.prototype._buttonSelectObject = function (c, f, e) {
    ...
    this._buttonButtonSelectObject = function (l, i, j) {
        ...
        this.obj.tr[window.dhx4.isIPad ? "ontouchend" : "onclick"] = function (m) {
            m = m || event;
            m.cancelBubble = true;
            if (!this.en) {
                return
            ...
            c.anyUsed = "none";
            var n = this.idd.replace(c.idPrefix, "");
            if (this.extAction) {
                try {
    ...
    this.setListOptionImage = function (j, g) {
        if (!this._isListButton(j)) {
            return
        }
        var i = this._listOptions[j].tr.childNodes[(c.rtl ? 1 : 0)];
        if (i.childNodes.length > 0) {
            i.childNodes[0].src = c.conf.icons_path + g
        } else {
            ...
            if (o.childNodes[b].tagName == "item") {
                ...
                for (var n = 0; n < o.childNodes[b].childNodes.length; n++) {
                    if (o.childNodes[b].childNodes[n].tagName == "item" && g.type == "buttonSelect") {
                        ...
                        var m = o.childNodes[b].childNodes[n].getElementsByTagName("itemText");
                        if (m != null && m[0] != null) {
                            v.itemText = m[0].firstChild.nodeValue
                        }
...
dhtmlXToolbarObject.prototype._addItemToStorage = function (f, h) {
    ...
    if (d != "" && this["_" + d + "Object"] != null) {
        ...
        if (d == "slider") {
            var c = {tip_template: "toolTip", value_min: "valueMin", value_max: "valueMax", value_now: "valueNow", text_min: "textMin", text_max: "textMax"};
            for (var b in c) {
        ...
        for (var b = 0; b < g[i].childNodes.length; b++) {
            if (g[i].childNodes[b].idd != null && g[i].childNodes[b].style.display != "none") {
                ...
                if (this.objPull[h] != null && this.objPull[h].obj == g[i].childNodes[b]) {
                    c[i].push({a: h, type: this.objPull[h].type, node: this.objPull[h][this.objPull[h].type == "buttonSelect" ? "arw" : "obj"]})
                }
            }
        }
        g[i] = null
...
dhtmlxArray._master = {_dhx_find: function (b) {
...
dhtmlXGridObject.prototype = {getRowAttribute: function (b, a) {
    ...
    var d = this.xmlLoader.doXPath("./head", e);
    if (d.length) {
        var f = this.xmlLoader.doXPath("./column", d[0]);
        var g = this.xmlLoader.doXPath("./settings", d[0]);
        var u = "setInitWidths";
        var p = false;
        if (g[0]) {
        ...
        this._launchCommands(this.xmlLoader.doXPath("./beforeInit/call", d[0]));
        if (f.length > 0) {
            if (this.hdr.rows.length > 0) {
                this.clearAll(true)
            }
            ...
            for (var t = 0; t < f.length; t++) {
                if ((this.cellType[t].indexOf("co") == 0) || (this.cellType[t] == "clist")) {
                    var l = this.xmlLoader.doXPath("./option", f[t]);
                    if (l.length) {
                        var q = new Array();
        ...
        this._launchCommands(this.xmlLoader.doXPath("./afterInit/call", d[0]))
    }
    var b = this.xmlLoader.doXPath("//rows/userdata", e);
    if (b.length > 0) {
    ...
    if (window.eXcell_tree) {
        ...
        eXcell_tree.prototype.setValue = function (m) {
    ...
    d.getXMLTopNode("rows");
    var e = d.doXPath("//rows")[0].getAttribute("parent") || 0;
    var g = {};
    ...
    for (var c = 0; c < j.length; c++) {
        ...
        g[a] = false;
        var e = h.parentNode.getAttribute("id") || e;
        if (this.rowsAr[a] && this.rowsAr[a].tagName != "TR") {
            ...
            if (this.rowsAr[a]) {
                this._process_xml_row(this.rowsAr[a], h, -1);
                this._postRowProcessing(this.rowsAr[a], true);
                if (this._fake && this._fake.rowsAr[a]) {
                    this._fake._process_xml_row(this._fake.rowsAr[a], h, -1)
                }
            } else {
                if (this._refresh_mode[1]) {
                    var f = {idd: a, data: h, _parser: this._process_xml_row, _locator: this._get_xml_data};
                    ...
                    if (this._h2) {
                        reset = true;
                        (this._h2.add(a, (h.parentNode.getAttribute("id") || h.parentNode.getAttribute("parent")))).buff = this.rowsBuffer[this.rowsBuffer.length - 1]
                    } else {
                        if (this._srnd) {
                            reset = true
                        }
...
}, i18n: {loading: "Loading", decimal_separator: ".", group_separator: ","}, _key_events: {k13_1_0: function () {
    ...
    var n = this.xmlLoader.doXPath(this.xml.cell, f);
    var l = [];
    a._attrs = this._xml_attrs(f);
    if (this._ud_enabled) {
        var m = this.xmlLoader.doXPath("./userdata", f);
    ...
    return c
}, _process_xml: function (d) {
    if (!d.doXPath) {
        var m = new dtmlXMLLoaderObject(function () {
        });
        if (typeof d == "string") {
            m.loadXMLString(d)
        } else {
            ...
            m.xmlDoc.responseXML = d
        }
        d = m
    }
    if (this._refresh_mode) {
        return this._refreshFromXML(d)
    }
    this._parsing = true;
    var g = d.getXMLTopNode(this.xml.top);
    if (g.tagName != this.xml.top) {
        return
    }
    var l = g.getAttribute("dhx_security");
    if (l) {
        dhtmlx.security_key = l
    }
    this._parseHead(g);
    var n = d.doXPath(this.xml.row, g);
    var f = parseInt(d.doXPath("//" + this.xml.top)[0].getAttribute("pos") || 0);
    var j = parseInt(d.doXPath("//" + this.xml.top)[0].getAttribute("total_count") || 0);
    var j = Math.min(j, 32000000 / this._srdh);
    var e = false;
    if (j && j != this.rowsBuffer.length) {
        if (!this.rowsBuffer[j - 1]) {
            if (this.rowsBuffer.length) {
                e = true
            }
            this.rowsBuffer[j - 1] = null
        }
        if (j < this.rowsBuffer.length) {
            this.rowsBuffer.splice(j, this.rowsBuffer.length - j);
            e = true
        }
    }
    if (this.isTreeGrid()) {
        return this._process_tree_xml(d)
    }
    for (var b = 0; b < n.length; b++) {
        if (this.rowsBuffer[b + f]) {
            continue
        }
        var a = n[b].getAttribute("id") || (b + f + 1);
        this.rowsBuffer[b + f] = {idd: a, data: n[b], _parser: this._process_xml_row, _locator: this._get_xml_data};
        this.rowsAr[a] = n[b]
    }
    ...
    this._parsing = false;
    return d.xmlDoc.responseXML ? d.xmlDoc.responseXML : d.xmlDoc
    ...
    for (var i = 0; i < data.length; i++) {
        var id = i + 1;
        this.rowsBuffer.push({idd: id, data: data[i], _parser: this._process_jsarray_row, _locator: this._get_jsarray_data});
    ...
    for (var b = 0; b < d.length; b++) {
        ...
        if (this._csvAID) {
            ...
            this.rowsBuffer.push({idd: e, data: a, _parser: this._process_jsarray_row, _locator: this._get_jsarray_data})
        }
        this.rowsAr[e] = d[b]
    }
    this.render_dataset();
        ...
        if (f == -1) {
            if (this.xmlFileUrl) {
                if (this.callEvent("onDynXLS", [c, (this._dpref ? this._dpref : (a - c))])) {
                    this.load(this.xmlFileUrl + getUrlSymbol(this.xmlFileUrl) + "posStart=" + c + "&count=" + (this._dpref ? this._dpref : (a - c)), this._data_type)
                }
            }
            a = c;
            break
    ...
    if (this._fillers) {
        ...
        if (!m) {
            this._fillers.push(this._add_filler(b, 1, (b == 0 ? {parentNode: this.obj.rows[0].parentNode, nextSibling: (this.rowsCol[1])} : this.rowsCol[b - 1])))
        }
        return l
    }
    this.rowsBuffer._dhx_insertAt(b, l);
...
dhtmlXGridObject.prototype._dragIn = function (e, c, b, f) {
    if (!this.dADTempOff) {
        return 0
    }
    var a = this.isTreeGrid();
    var d = c.parentNode.idd ? c.parentNode : c.parentObject;
    if (this._drag_validate) {
        if (e.parentNode == c.parentNode) {
            return 0
        }
        if ((a) && (this == d.grid) && ((this.checkParentLine(this._h2.get[e.parentNode.idd], c.parentNode.idd)))) {
            return 0
        }
    }
    if (!this.callEvent("onDragIn", [d.idd || d.id, e.parentNode.idd, d.grid || d.treeNod, (e.grid || e.parentNode.grid)])) {
        return this._setMove(e, b, f, true)
    }
    this._setMove(e, b, f);
    if ((a) && (e.parentNode.expand != "")) {
        this._autoOpenTimer = window.setTimeout(new callerFunction(this._autoOpenItem, this), 1000);
        this._autoOpenId = e.parentNode.idd
    } else {
        if (this._autoOpenTimer) {
            window.clearTimeout(this._autoOpenTimer)
        }
...
dhtmlXGridObject.prototype.toPDF = function (e, l, p, n, i, t) {
    var f = {row: this.getSelectedRowId(), col: this.getSelectedCellIndex()};
    ...
    function s(v) {
        var C = [];
        for (var z = 1; z < a.hdr.rows.length; z++) {
            C[z] = [];
            for (var y = 0; y < a._cCount; y++) {
                var E = a.hdr.rows[z].childNodes[y];
                if (!C[z][y]) {
                    C[z][y] = [0, 0]
                }
                if (E) {
                    C[z][E._cellIndexS] = [E.colSpan, E.rowSpan]
                }
            }
        }
        var A = "<rows profile='" + v + "'";
        if (p) {
            A += " header='" + p + "'"
        }
        if (n) {
        ...
        A += "><head>" + a._serialiseExportConfig(C).replace(/^<head/, "<columns").replace(/head>$/, "columns>");
        for (var z = 2; z < a.hdr.rows.length; z++) {
            var d = 0;
            var I = a.hdr.rows[z];
            var D = "";
            for (var y = 0; y < a._cCount; y++) {
                if ((a._srClmn && !a._srClmn[y]) || (a._hrrar[y] && (!a._fake || y >= a._fake.hdrLabels.length))) {
                    d++;
                    continue
                }
                var H = C[z][y];
                var F = ((H[0] && H[0] > 1) ? ' colspan="' + H[0] + '" ' : "");
                if (H[1] && H[1] > 1) {
                    F += ' rowspan="' + H[1] + '" ';
                    d = -1
                }
                var u = "";
                var x = I;
                if (a._fake && y < a._fake._cCount) {
                    x = a._fake.hdr.rows[z]
                }
                for (var w = 0; w < x.cells.length; w++) {
                    if (x.cells[w]._cellIndexS == y) {
                        if (x.cells[w].getElementsByTagName("SELECT").length) {
                            u = ""
                        } else {
                            u = _isIE ? x.cells[w].innerText : x.cells[w].textContent
                        }
                        u = u.replace(/[ \n\r\t\xA0]+/, " ");
                        break
                    }
    ...
    function c() {
        ...
        if (i) {
            for (var u = 0; u < i.length; u++) {
                d.push(o(a.getRowIndex(i[u])))
            }
        } else {
            for (var u = 0; u < a.getRowsNum(); u++) {
                d.push(o(u))
            }
        }
        return d.join("\n")
    ...
    function j() {
        ...
        for (var w = 1; w < a.ftr.rows.length; w++) {
            v.push("<columns>");
            var z = a.ftr.rows[w];
            for (var u = 0; u < a._cCount; u++) {
                if (a._srClmn && !a._srClmn[u]) {
                    continue
                }
                if (a._hrrar[u] && (!a._fake || u >= a._fake.hdrLabels.length)) {
                    continue
                }
                for (var d = 0; d < z.cells.length; d++) {
                    var y = "";
                    var x = "";
                    if (z.cells[d]._cellIndexS == u) {
                        y = _isIE ? z.cells[d].innerText : z.cells[d].textContent;
                        y = y.replace(/[ \n\r\t\xA0]+/, " ");
                        if (z.cells[d].colSpan && z.cells[d].colSpan != 1) {
                            x = " colspan='" + z.cells[d].colSpan + "' "
                        }
                        if (z.cells[d].rowSpan && z.cells[d].rowSpan != 1) {
                            x = " rowspan='" + z.cells[d].rowSpan + "' "
                        }
                        break
                    }
                }
                v.push("<column" + x + "><![CDATA[" + y + "]]></column>")
            }
            v.push("</columns>")
        }
        v.push("</foot>");
    ...
    function h(u, d) {
        return(window.getComputedStyle ? (window.getComputedStyle(u, null)[d]) : (u.currentStyle ? u.currentStyle[d] : null)) || ""
    }
    ...
    function o(w) {
        ...
        var d = a.render_row(w);
        if (d.style.display == "none") {
            return""
        }
        var u = a.isTreeGrid() ? ' level="' + a.getLevel(d.idd) + '"' : "";
        var A = "<row" + u + ">";
        for (var y = 0; y < a._cCount; y++) {
            if (((!a._srClmn) || (a._srClmn[y])) && (!a._hrrar[y] || (a._fake && y < a._fake.hdrLabels.length))) {
                var F = a.cells(d.idd, y);
                if (q) {
                    var x = h(F.cell, "color");
                    var E = h(F.cell, "backgroundColor");
                    var D = h(F.cell, "font-weight") || h(F.cell, "fontWeight");
                    var z = h(F.cell, "font-style") || h(F.cell, "fontStyle");
                    var C = h(F.cell, "text-align") || h(F.cell, "textAlign");
                    var v = h(F.cell, "font-family") || h(F.cell, "fontFamily");
                    if (E == "transparent" || E == "rgba(0, 0, 0, 0)") {
                        E = "rgb(255,255,255)"
                    }
                    A += "<cell bgColor='" + E + "' textColor='" + x + "' bold='" + D + "' italic='" + z + "' align='" + C + "' font='" + v + "'>"
                } else {
                    A += "<cell>"
                }
                A += "<![CDATA[" + (F.getContent ? F.getContent() : F.getTitle()) + "]]></cell>"
            }
        }
        return A + "</row>"
    }
    ...
    var g = "form_" + a.uid();
    r.innerHTML = '<form id="' + g + '" method="post" action="' + e + '" accept-charset="utf-8"  enctype="application/x-www-form-urlencoded"' + this.target + '><input type="hidden" name="grid_xml" id="grid_xml"/> </form>';
    document.getElementById(g).firstChild.value = encodeURIComponent(s(l).replace("\u2013", "-") + c() + m());
...
dhtmlXGridObject.prototype._serialiseExportConfig = function (f) {
    ...
    for (var c = 0; c < this.hdr.rows[0].cells.length; c++) {
        ...
        if (this._asCDATA) {
            b += "<![CDATA[" + this.getHeaderCol(c) + "]]>"
        } else {
            b += this.getHeaderCol(c)
        }
...
dhtmlXGridObject.prototype.collectValues = function (e) {
    var n = this.callEvent("onCollectValues", [e]);
    if (n !== true) {
        return n
    }
    if (this.isTreeGrid()) {
...
dhtmlXGridObject.prototype.csvParser = {block: function (a, b) {
    return a.join(b)
...
dhtmlXGridObject.prototype.csvExtParser = {_quote: RegExp('"', "g"), _quote_esc: RegExp('\\\\"', "g"), block: function (a, b) {
    return a.join(b)
...
if (!window.clipboardData) {
    window.clipboardData = {_make: function () {
        ...
        try {
            ...
            dhtmlxError.throwError("Clipboard", "Access to clipboard denied", [a, d]);
            return""
        }
        if (!this._make()) {
            return false
...
dhtmlXGridObject.prototype.getSelectedBlock = function () {
    if (this._selectionArea) {
        ...
        if (this.getSelectedRowId() !== null) {
            return{LeftTopRow: this.getSelectedRowId(), LeftTopCol: this.getSelectedCellIndex(), RightBottomRow: this.getSelectedRowId(), RightBottomCol: this.getSelectedCellIndex()}
        } else {
            return null
        }
    }
...
dhtmlXGridObject.prototype.enableSmartRendering = function (c, b, a) {
    ...
    this._srnd = convertStringToBoolean(c);
...
dhtmlxValidation.prototype = {trackInput: function (c, d, b, a) {
