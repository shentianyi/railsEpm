...
//        });
        ...
        if (chart_body_close_validate) {
            ...
            option.data = [
//                {low: 0,high:3, target: 10, unit: "$"},
//                {low: 1,high:20, target: 10, unit: "$"},
//                {low: 20,high:54, target: 10, unit: "$"},
//                {low: 3,high:32, target: 10, unit: "$"},
//                {low: 40,high:43, target: 10, unit: "$"},
//                {low: 14,high:43, target: 10, unit: "$"}
                {y: 2, target: 10, unit: "$"},
                {y: 3, target: 10, unit: "$"},
                {y: 21, target: 10, unit: "$"},
                {y: 3, target: 10, unit: "$"},
