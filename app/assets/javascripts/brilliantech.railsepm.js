            ...
            $.post('', {
                ...
                if(data.result) {
                    ...
                    $("#manage-group-kpi li:eq(" + length + ")").before($("<li />")
                        .append($("<i />").addClass("icon-remove hide pull-left").click(remove_leftNav).attr("number", data.object).attr("belong", "dashView"))
                        .append($("<i />").addClass("icon-pencil hide pull-left").click(edit_leftNav).attr("number", data.object).attr("belong", "dashView"))
                        .append($("<a href='../kpis?p=" + data.object + "'/>").text(val).attr("number", data.object).attr("belong", "dashView")));
                    $("#creat-newEntity").val("");
                } else {
                    alert(data.content);
                }
