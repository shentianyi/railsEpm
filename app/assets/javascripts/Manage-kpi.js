...
MANAGE.kpi.add_new_kpi=function(){
    var option={
        ...
        direction :  $("#add-trend :selected").text()==false ? $("#add-trend :first").attr("value") : $("#add-trend :selected").attr("value"),
        trend : $("#add-trend :selected").text()==false ? $("#add-trend :first").text() : $("#add-trend :selected").text() ,
