Department.transaction do
  ...
  Entity.where("name like 'ET-%' or name like 'ES-%' or name like 'TL%'").each do |e|
    e.destroy
  end

  User.where("email like 'et%' or email like 'es%' or email like 'tl%'").each do |e|
    e.destroy
  end
end
...
Department.transaction do
  ...
  sensors={
      ...
      'TL Main Assembly Line' => ['Q-C25', 'Q-C34', 'Q-C36', 'Q-C38', 'Q-C41', 'Q-C43', 'Q-C44', 'Q-C42', 'Q-C24', 'Q-C70', 'Q-C72', 'Q-C79', 'Q-C107', 'Q-C74', 'Q-C76', 'Q-C77', 'Q-C78', 'Q-C80', 'Q-C81', 'Q-C82', 'Q-C84', 'Q-C106', 'Q-85', 'Q-C86', 'Q-C87', 'Q-C97', 'Q-C98', 'Q-C101', 'Q-C102', 'Q-C103', 'Q-C104', 'Q-C105'],
  }
