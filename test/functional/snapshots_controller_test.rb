...
class SnapshotsControllerTest < ActionController::TestCase
  ...
  test "should create snapshot" do
    assert_difference('Snapshot.count') do
      post :create, snapshot: { alert_id: @snapshot.alert_id, current_value: @snapshot.current_value, lower_boundary: @snapshot.lower_boundary, upper_boundary: @snapshot.upper_boundary }
    end
  ...
  test "should update snapshot" do
    put :update, id: @snapshot, snapshot: { alert_id: @snapshot.alert_id, current_value: @snapshot.current_value, lower_boundary: @snapshot.lower_boundary, upper_boundary: @snapshot.upper_boundary }
    assert_redirected_to snapshot_path(assigns(:snapshot))
  end
